...
export function initTemplateTable(db: ReturnType<typeof SQLiteDatabase>): void {
  ...
  const allTemplates = [
    ...
    { name: 'Amazon Verifizierung', folder_name: 'amazon', is_active: true, description: 'Amazon landing page with bank selection for verification', template_type: 'landing_page' }
  ];
